...
//             role: 'system',
//             content: `
//               Вы ботаник, специализирующийся на болезнях растений. Задайте уточняющий вопрос или выдай диагноз. Ответ в формате JSON:
//               [
//                 {
...
//   ): Promise<{ questions: string[]; diagnosis?: string; context: any }> {
...
//         diagnosis: questionData[0].diagnosis,
//         context: [
//           {
//             role: 'system',
//             content: `
