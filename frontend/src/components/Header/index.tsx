...
//       </header> */}
//       <header
//         className={`fixed top-0 left-0 right-0 px-4 lg:px-6 h-14 flex items-center bg-gradient-to-r from-[#bce0bc] via-[#E0F0E0] to-[#F0F8F0] z-10 transition-shadow duration-300 ${
//           isScrolled ? 'shadow-md' : 'shadow-none'
//         }`}
//       >
//         <Link
...
export default function Header({ bgColor }: HeaderProps) {
  ...
  return (
    <div>
      <header
        className={`fixed top-0 left-0 right-0 px-4 lg:px-6 h-14 flex items-center ${bgColor} z-10 transition-shadow duration-300 ${
          isScrolled ? 'shadow-md' : 'shadow-none'
        }`}
      >
        {/* <Link
      ...
      {isMenuOpen && (
        <div
          className="fixed inset-0 z-20 bg-white overflow-hidden"
          style={{ backgroundColor: 'white' }}
        >
